        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.edit').click(function() {
                	...
                	$('#txtName').val($('.line' + id + ' td.colName').html());
